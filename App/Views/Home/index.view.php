    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse nav-tabs navbar-font-edit" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto">
                <li class="nav-item"><a class="nav-link" href="public/html/Index.html"><h3>Úvod</h3></a></li>
                <li class="nav-item"><a class="nav-link" href="public/html/Offer.html"><h3>Ponuka</h3></a></li>
                <li class="nav-item"><a class="nav-link" href="public/html/Contact.html"><h3>Kontakt</h3></a></li>
            </ul>
        </div>
    </nav>
...
<main class="container prevent-select">
    ...
    <div class="row g-5">
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-3">
                    <img src="public/img/coffeeHome4.jpg" alt="Coffee Home" class="center-photo">
                </div>
                <div class="col-6">
                    <img src="public/img/coffeeHome3.jpg" alt="Coffee Home" class="center-photo">
                </div>
                <div class="col-3">
                    <img src="public/img/coffeeHome2.jpg" alt="Coffee Home" class="center-photo">
                </div>
            </div>
